...
const reqSeries = fs.readFileSync('row-請購單號.txt'); // this is id
const member = fs.readFileSync('row-採購人員.txt');
const cost = fs.readFileSync('row-未稅單價.txt');
const date = fs.readFileSync('row-原始到廠日期.txt');
